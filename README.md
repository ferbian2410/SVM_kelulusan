...
Status Kehadiran,Kategorikal,"Status keaktifan mahasiswa (e.g., Aktif, Cuti)."
Keaktifan Organisasi,Numerik (int),"Indikator keaktifan di organisasi (1=Aktif, 0=Tidak)."
